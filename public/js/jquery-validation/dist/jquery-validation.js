...
$.extend($.validator, {
	...
	messages: {
		...
		dateTime: "Please enter a valid date time value."
	},
	...
	methods: {
		...
		dateTime: function(value, element) {
			return this.optional(element) || /^\d{1,2}[\/-]\d{1,2}[\/-]\d{4}\s\d{1,2}[\:]\d{1,2}$/.test(value);
		},
		dateTimeMoreThan: function(value, element, param) {
			value=parseDateTime(value);
			param=parseDateTime(param);
			return value > param;
		},
		dateTimeLessThan: function(value, element, param) {
			value=parseDateTime(value);
			param=parseDateTime(param);
			return value < param;
		},
