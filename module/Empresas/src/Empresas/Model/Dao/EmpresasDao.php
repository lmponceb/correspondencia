 ...
 class EmpresasDao
 {
     ...
     public function traerTodosPorJerarquia()
     {
        ...
        */
        ...
        $sql =" SELECT EMP_ID, EMP_DIRECCION, EMP_ID as PADRE, EMP_NOMBRE, '' AS PADRE_NOMBRE ,EMP_EMAIL,EMP_PAGINA_WEB, 0 AS NIVEL, EMP_ESTADO FROM EMPRESA WHERE (EMP_EMP_ID IS NULL OR EMP_EMP_ID = 0) ";
        $sql.=" UNION ";
