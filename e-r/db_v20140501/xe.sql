...
/* Created on:     01/05/2014 17:29:50                          */
/*==============================================================*/
...
alter table CONTACTO
   drop constraint FK_CONTACTO_RELATIONS_EMPRESA;
...
/*==============================================================*/
create index RELATIONSHIP_32_FK on CONTACTO (
   EMP_ID ASC
);
...
alter table CONTACTO
   add constraint FK_CONTACTO_RELATIONS_EMPRESA foreign key (EMP_ID)
