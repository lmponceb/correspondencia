...
drop table carta_fima cascade constraints;
...
/* Table: carta_fima                                            */
/*==============================================================*/
create table carta_fima  (
   epl_id               number(11)                      not null,
   ctr_id               number(11)                      not null,
   constraint pk_carta_fima primary key (epl_id, ctr_id)
);

/*==============================================================*/
/* Index: car_fir_epl_id_fk                                     */
/*==============================================================*/
create index car_fir_epl_id_fk on carta_fima (
   epl_id asc
);
...
/*==============================================================*/
create index car_fir_car_id_fk on carta_fima (
   ctr_id asc
);
